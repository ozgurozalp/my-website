...
coverImage: /images/laravel-nedir.png
author:
  name: Özgür ÖZALP
...
4. [Windows’ta Laravel Kurulumu](#windows-için-gereksinimler)
5. [macOS’te Laravel Kurulumu](#mac-os-için-gereksinimler)
6. [İlk Laravel Projesi Oluşturma](#i̇lk-laravel-projesi-oluşturma)
7. [Laravel Proje Yapısı](#laravel-proje-yapısı)
8. [Örnek Bir Routes ve Controller Kullanımı](#örnek-bir-routes-ve-controller-kullanımı)
9. [Sonuç](#sonuç)
