...
- **Tek thread:** JavaScript'in doğası gereği tip denetimi tek thread üzerinde koşuyordu. 16 çekirdekli makinenizde `tsc` çalışırken 15 çekirdek boş oturuyordu.
- **GC baskısı:** Milyonlarca küçük AST düğümü, JS nesne modeliyle temsil edilince bellek kullanımı şişiyor, GC sürekli devreye giriyordu.
...
2. **Garbage collector.** Derleyiciler graf yapılarıyla çalışır ve bu graflarda kimin neyin sahibi olduğu belirsizdir. Go'nun GC'si burada engel değil, kolaylık.
